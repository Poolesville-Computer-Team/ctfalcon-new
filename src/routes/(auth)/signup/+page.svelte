	...
	<div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
		<form method="POST" use:enhance>
			...
			<Field
				...
				required
			/>
			<Field label="Password" name="password" type="password" placeholder="Password" required />
			<Field
			...
			<div class="form-control w-full">
				...
				<label for="country" class="label">
					<span class="label-text-alt">ISO-3166-1</span>
				</label>
			</div>
			...
			<div class="form-control mb-4 w-full">
				...
				>
					...
					<option value="nonBinaryGenderFluid">Non-Binary/Gender Fluid</option>
					<option value="notListedPreferNotToAnswer">Not Listed/Prefer Not to Answer</option>
				</select>
			</div>
			<Field
				label="Postal Code"
